...
<body style="height: auto; background-color: #ffffff; color: #000000;">
    <h2 style="text-align: center; font-weight: 600;">memoflick</h2>
    <div class="container" 
      style="width: 600px;
        height: auto;
        margin: auto;
        ...
        <div class="mail-card" 
          ...
          <div class="subtitle" style="font-size: 16px; color: #54a9c4;">Wish them a happy birthday</div>
          </div>
